...
Revently I've worked a bit also on the **WebAuthor** online editing tool (DITA Map tree editor) and **Content Fusion** (Workspace Search support and support to update references when files are renamed/moved).
